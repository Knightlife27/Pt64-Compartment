...
export const PropertyListing = ({ property, categories, onSaveToCategory, onAddCategory }) => {
      ...
      fetch('/api/addListingToCategory', {
        ...
        body: JSON.stringify({
          listingName: {
            ...
            categoryId: selectedCategory,
            propertyDetails: {
              address: `${property.location?.address?.line ?? 'N/A'}, ${property.location?.address?.city ?? 'N/A'}, ${property.location?.address?.state_code ?? 'N/A'} ${property.location?.address?.postal_code ?? 'N/A'}`,
              price: `${property.list_price || property.list_price_max || 'N/A'}`,
              beds: `${getBedsDescription(property.description?.beds, property.description?.beds_max)}`,
              baths: `${property.description?.baths || property.description?.baths_max || 'N/A'}`,
              photos: `${property.photos ? property.photos.map(photo => photo.href) : []}`,
            }
          }
        }),
  ...
  if (!property || !property.location || !property.location.address) {
      ...
      <div className="property-info">
        ...
        <div className='property-meta'>
          <h3>
            ...
            {property.location.address.city ?? 'N/A'}, 
            {property.location.address.state_code ?? 'N/A'} 
            {property.location.address.postal_code ?? 'N/A'}
          </h3>
          <div className='property-price'>
            <p>Price: ${property.list_price || property.list_price_max || 'N/A'}</p>
          </div>
          <p>
            {getBedsDescription(property.description?.beds, property.description?.beds_max)}, 
            {property.description?.baths || property.description?.baths_max || 'N/A'} baths
          </p>
        </div>
