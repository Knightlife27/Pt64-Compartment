...
export const CarouselPropertyListing = ({ property, categories, onSaveToCategory, onAddCategory }) => {
  ...
  const handleContactAgent = (property) => {
    ...
    console.log("Contacting agent for property:", property);
  };
      ...
      <div className="carousal-property-info">
        ...
        <div className='carousal-property-meta'>
          ...
          <div className="property-buttons">
            ...
            <Button variant="secondary" onClick={() => handleContactAgent(property)}>Contact Agent</Button>
          </div>
        </div>
...
export default CarouselPropertyListing;